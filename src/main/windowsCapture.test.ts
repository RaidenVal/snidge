...
import {
  ...
  buildWindowsCaptureRequestLine
} from './windowsCapture'
...
describe('buildWindowsCaptureRequestLine', () => {
  it('converts rect + cursor into a space-separated request line', () => {
    expect(
      buildWindowsCaptureRequestLine({
        rect: { x: 0, y: 0, width: 3440, height: 1440 },
        cursor: { x: 100, y: 200 }
      })
    ).toBe('0 0 3440 1440 100 200')
  })
